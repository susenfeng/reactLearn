...
!function() {
    function t(t, e) {
        ...
        console.log('1111111111111111111111',window.requestAnimFrame)
    ...
    t.fn.svg3DTagCloud = function(e) {
        ...
        return this.each(function() {
            if (t.data(this, "plugin_SVG3DTagCloud")) {
                ...
                t.data(this, "plugin_SVG3DTagCloud", new window.SVG3DTagCloud(
                    this, e))
        })
    }
}(jQuery);
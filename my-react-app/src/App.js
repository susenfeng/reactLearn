...
class App extends Component {
  render() {
      ...
      console.log('11111111111',window.SVG3DTagCloud);
      console.log('2222222222222',window.document.getElementById( 'holder'  ));
     ...
     // document.getElementById('#holder').svg3DTagCloud( settings );
      ...
      // console.log('111111111111111',$('#holder'))
    ...
    return (
      <div className="App">
        <header className="App-header">
          ...
          <h1 className="App-title">this is first MY-React-Demo</h1>
        </header>
        <p className="App-intro">
          To get started, edit <code>src/App.js</code> and save to reload.
        </p>

          <div id='holder'>vzxvzxvzx</div>
      </div>
    );


      // ReactDOM.render(
      //     console.log('2222222222222',document.getElementById('holder'));
      // );
  }
